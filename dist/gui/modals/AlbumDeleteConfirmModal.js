export class AlbumDeleteConfirmModal {
    constructor() {
        this.container = null;
    }
    show(albumName) {
        return new Promise((resolve) => {
            ...
            header.textContent = 'Удаление альбома';
            const body = document.createElement('p');
            body.className = 'dynamic-confirm-body-text';
            body.textContent = `Вы уверены, что хотите полностью удалить альбом "${albumName}" с диска?`;
...
//# sourceMappingURL=AlbumDeleteConfirmModal.js.map